...
const DashboardSidebar = ({ activeSection, onSectionChange, currentUser }) => {
  const menuItems = [
    ...
    { id: 'usuarios', name: 'Control Usuarios', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          return (
            <button
              ...
              className={[
                ...
                isActive
                  ? 'bg-blue-50 dark:bg-slate-700 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-slate-600'
