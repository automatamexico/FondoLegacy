    ...
    <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-lg">
        ...
        <div className="flex items-center space-x-4 mb-4">
          ...
          <div>
            ...
            <div className="text-sm text-slate-600 mt-1">
              Teléfono:{" "}
              <span className="font-medium text-slate-900">{afiliado.telefono || "-"}</span>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {/* pediste estos */}
          <div className="p-3 bg-slate-50 rounded-lg">
            <div className="text-xs text-slate-500">Creado (created_at)</div>
            <div className="font-medium">{fmtDateTime(afiliado.created_at)}</div>
          </div>

          <div className="p-3 bg-slate-50 rounded-lg">
            <div className="text-xs text-slate-500">Actualizado (updated_at)</div>
